          ...
          <form>
            <div class="grid gap-y-4">
              <div>
                ...
                <p class="hidden text-xs text-red-600 mt-2" id="email-error">โปรดระบุที่อยู่อีเมลที่ถูกต้องเพื่อให้เราติดต่อกลับได้</p>
              </div>
              <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500  hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">เปลี่ยนรหัสผ่าน</button>
            </div>
          </form>
        </div>
      </div>
