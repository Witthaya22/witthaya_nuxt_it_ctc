...
<template>
  <div class="flex min-h-screen backgroundCustom backdrop-blur-xl shadow-lg">
    <aside class=" w-44 flex flex-col sticky top-0 h-screen  backdrop-blur-lg shadow-lg">
